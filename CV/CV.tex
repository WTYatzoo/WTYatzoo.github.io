...
\begin{rSection}{Biography}
  %I am looking for a graphics/vision R\&D engineer position in the industrial job market of Hangzhou.\\\\
...
\begin{rSection}{Selected related Projects}
  ...
  \\{\bf Static hair/cloth retargeting}\\ Research\&Development for retargeting a hair/cloth model from one suited figure to another different figure. Very quick(in four days) to find and implement a solution of hair retargeting by ARAP energy based deformation and  the artists gave a good feedback of my work. After surveying some cloth retargeting papers in SIGGRAPH/CVPR, find a suitable solution for the artists. See the \emph{\href{https://wtyatzoo.github.io/reports/retargeting.pdf}{retargeting report}} for details. \\
