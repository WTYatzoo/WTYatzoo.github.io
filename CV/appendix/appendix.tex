...
\begin{rSection}{Full Graphics related Projects I have coded successfully}
  \textbf{Solid deformation and simulation related:}\\
         ...
         \textbf{Fluid simulation related:}\\
                ...
                {\bf FLIP or PIC based water simulation with boundary correction}\\A simplified FlIP or PIC fluid solver with the boundary correction based on the paper \emph{A Fast Variational Framework for Accurate Solid-Fluid Coupling} without the implementation of its two way coupling part.\\\\
